...
run_train() {
  ...
  if [[ "${method}" == "es_weighted" || "${method}" == "sgfn" || "${method}" == "pbcl" || "${method}" == "pccl" || "${method}" == "rr_gcl" || "${method}" == "hybrid_rr_gcl" || "${method}" == "cbr_gcl" || "${method}" == "gated_cbr_gcl" || "${method}" == "stable_cluster_cbr_gcl" ]]; then
