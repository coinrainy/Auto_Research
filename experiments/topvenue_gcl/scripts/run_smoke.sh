...
python train.py --dataset Cora --method danv_gcl --epochs 2 --seed 0 --split-index 0 --skip-eval --run-name smoke_cora_danv
...
python train.py --dataset Texas --method danv_gcl --epochs 2 --seed 0 --split-index 0 --skip-eval --run-name smoke_texas_danv
