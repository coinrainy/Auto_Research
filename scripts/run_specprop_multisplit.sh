  ...
  for split_seed in "${SPLIT_SEEDS[@]}"; do
    for method in "${METHODS[@]}"; do
      python -m homogcl.train \
        ...
        --output-dir results/specprop_multisplit
    done
  done
done

python -m homogcl.summarize --input-dir results/specprop_multisplit --output-csv results/specprop_multisplit_summary.csv
python -m homogcl.select --input-dir results/specprop_multisplit --output-csv results/specprop_multisplit_selected.csv --mode run
